...
// The stats module directly rather than the player barrel: this constant is
// read at load time, and going through the barrel put it in an import cycle
// (util/index -> ... -> getAwardCandidates -> here -> player/index -> util)
// that left `player` undefined while this file was still being evaluated.
