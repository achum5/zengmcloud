				...
				.map((p2) => {
					...
					return {
						...
						currentStats: {
							...
							score: p.scores[award.shortName],
						} as {
							score: number | undefined;
						} & (typeof p)["currentStats"]["regularSeason"],
						opoyOverride: p2.opoyOverride,
						statOverrides: p2.statOverrides,
						// American odds on winning the race, filled in for the current
						// season by the award races view from the sportsbook's model
						// (core/season/getAwardRaceOdds).
