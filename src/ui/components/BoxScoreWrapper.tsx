...
const NextButton = ({
	...
	// Same sim authority lock as the Play menu: can't sim forward unless this device
	// is in charge of simming and is connected (the worker enforces it too).
	const { locked: simAuthorityLocked, reason: simAuthorityReason } =
		useSimAuthorityLocked();
